...
The measurements were done in a flat and vertical position, with two source positions for the vertical setup, as shown in Figure~\ref{fig:pwo:lightyield:ej200:setup}.
